...
class MstCustomerRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'name_en' => 'required|max:100|unique:mst_suppliers,name_en'.$sup_org_check,
            'name_lc' => 'max:100|unique:mst_suppliers,name_lc'.$sup_org_check,
            'country_id'=>'required',
            'email'=>'required|email|unique:mst_suppliers,email'.$sup_org_check,
