...
class MstDepartmentRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'name_en' => 'required|unique:mst_departments,name_en'. $sup_org_check,
            'name_lc' => 'unique:mst_departments,name_lc'. $sup_org_check,
        ];
    }
