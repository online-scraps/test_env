...
class PurchaseReturnSequenceRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'name_en' => 'required|max:100|unique:purchase_return_sequences,name_en'.$id_check,
            'name_lc' => 'max:100|unique:purchase_return_sequences,name_lc'.$id_check,
