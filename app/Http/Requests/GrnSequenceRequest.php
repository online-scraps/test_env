...
class GrnSequenceRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'name_en' => 'required|max:100|unique:grn_sequences,name_en'.$id_check,
            'name_lc' => 'max:100|unique:grn_sequences,name_lc'.$id_check,
