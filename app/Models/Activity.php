...
class Activity extends Model implements ActivityContract
{
    ...
    public function changes(): Collection
    {
        ...
        // dd($this->properties->only(['attributes', 'old']));
    ...
    {
        if ($this->causer_type) {
            return Str::replace('App\\Models\\', '', $this->causer_type);;
        } else {
    ...
    public function getModelName()
    {
        if ($this->subject_type) {
            $str = Str::replace('App\\Models\\', '', $this->subject_type);
            if (Str::contains($str, 'Mst')) {
                $str = Str::replace('Mst', '', $str);
            }
    ...
    //Btn Delete all ACtivities
    public function deleteAllActivityBtn()
    {
        # code...
    }
}
