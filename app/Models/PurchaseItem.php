...
class PurchaseItem extends BaseModel
{
    ...
    */
    ...
    protected $fillable = ['purchase_qty','sup_org_id','free_qty','po_id','total_qty','discount',
    'purchase_price','sales_price','item_amount','tax_vat','items_id','discount_mode_id','store_id'];
    // protected $hidden = [];
    // protected $dates = [];
    ...
    */
    public function itemEntity(){
        return $this->belongsTo(MstItem::class,'items_id','id');
    }
