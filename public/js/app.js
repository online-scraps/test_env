...
try {
  ...
  __webpack_require__(/*! ./inventory-libraries */ "./resources/js/inventory-libraries.js");
} catch (e) {}
...
/***/ "./resources/js/inventory-libraries.js":
/*!*********************************************!*\
  !*** ./resources/js/inventory-libraries.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
var INVENTORY = {
  ...
  inventoryLoading: function inventoryLoading(bool) {
    var status = bool === true ? 'show' : 'hide';
    $.LoadingOverlay(status, {
      text: "Saving..."
    });
  },
  fetchEmployeeById: function fetchEmployeeById(item) {
    var employeeId = item.value;
    var url = '/admin/fetch_employee_detail';
    if (employeeId != '') {
      $.ajax({
        type: 'GET',
        url: url,
  ...
  multipleDependentStore: function multipleDependentStore() {
    var store = $("#store_id").val();
    console.log(store);
    $("#store_hidden_id").val(store);
  },
  fetchPurchaseitem: function fetchPurchaseitem() {
  ...
  fetchSalesReceipt: function fetchSalesReceipt() {
  ...
  setIsTaxableField: function setIsTaxableField() {
  ...
  numberToEnglishWord: function numberToEnglishWord(number) {
    ...
    i = 0;
    str = new Array();
    words = [" ", "ONE", "TWO", "THREE", "FOUR", "FIVE", "SIX", "SEVEN", "EIGHT", "NINE", "TEN", "ELEVEN", "TWELVE", "THIRTEEN", "FOURTEEN", "FIFTEEN", "SIXTEEN", "SEVENTEEN", "EIGHTEEN", "NINETEEN", "TWENTY", "TWENTY ONE", "TWENTY TWO", "TWENTY THREE", "TWENTY FOUR", "TWENTY FIVE ", "TWENTY SIX", "TWENTY SEVEN", "TWENTY EIGHT", "TWENTY NINE", "THIRTY", "THIRTY ONE", "THIRTY TWO", "THIRTY THREE", "THIRTY FOUR", "THIRTY FIVE", "THIRTY SIX", "THIRTY SEVEN", "THIRTY EIGHT", "THIRTY NINE", "FORTY", "FORTY ONE", "FORTY TWO", "FORTY THREE", "FORTY FOUR", "FORTY FIVE", "FORTY SIX", "FORTY SEVEN", "FORTY EIGHT", "FORTY NINE", "FIFTY", "FIFTY ONE", "FIFTY TWO", "FIFTY THREE", "FIFTY FOUR", "FIFTY FIVE", "FIFTY SIX", "FIFTY SEVEN", "FIFTY EIHT", "FIFTY NINE", "SIXTY", "SIXTY ONE", "SIXTY TWO", "SIXTY THREE", "SIXTY FOUR", "SIXTY FIVE", "SIXTY SIX", "SIXTY SEVEN", "SIXTY EIGHT", "SIXTY NINE", "SEVENTY", "SEVENTY ONE", "SEVENTY TWO", "SEVENTY THREE", "SEVENTY FOUR", "SEVENTY FIVE", "SEVENTY SIX", "SEVENTY SEVEN", "SEVENTY EIGHT", "SEVENTY NINE", "EIGHTY", "EIGHTY ONE", "EIGHTY TWO", "EIGHTY THREE", "EIGHTY FOUR", "EIGHTY FIVE", "EIGHTY SIX", "EIGHTY SEVEN", "EIGHTY EIGHT", "EIGHTY NINE", "NINETY", "NINETY ONE", "NINETY TWO", "NINETY THREE", "NINETY FOUR", "NINETY FIVE", "NINETY SIX", "NINETY SEVEN", "NINETY EIGHT", "NINETY NINE", "HUNDRED"];
  ...
  numberToEnglishNumberSystemWord: function numberToEnglishNumberSystemWord(number) {
    var numberToWords = __webpack_require__(/*! number-to-words */ "./node_modules/number-to-words/numberToWords.min.js");
    if (number) {
