...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="row" data-init-function="bpFieldInitPageOrLinkElement">
        ...
        <div class="col-sm-9">
            {{-- internal link input --}}
            <div class="page_or_link_value internal_link {{ (isset($entry) && $entry->{$field['name']['type']} === 'internal_link') || (isset($entry) && !$entry->{$field['name']['type']} && !$field['allows_null']) || (!isset($entry) && !$field['allows_null']) ? '' : 'd-none' }}">
                <input
                    type="text"
                    class="form-control"
