	...
	<section class="container-fluid d-print-none">
		<h2>
	        ...
	        @if ($crud->hasAccess('list'))
	          <small class="back-btn"><a href="{{ url($crud->route) }}" class="font-sm"><i class="la la-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{ $crud->entity_name_plural }}</span></a></small>
	        @endif
	    </h2>
    </section>
@endsection
...
<div class="row">
	<div class="{{ $crud->getShowContentClass() }}">
		<a href="javascript: window.print();" class="btn btn-primary float-right print-btn"><i class="la la-print"></i></a>
