...
@section('content')
    ...
    <form id="stockTransferForm" action="{{ url($crud->route) }}" method="POST">
        @csrf
            ...
            <div class="row mt-3">
                <div class="col-xl-4 col-md-4 col-sm-6">
                    <div class="input-group mb-3">
                        ...
                        <select class="form-select store_id" id="from_store_id"  name="from_store_id" style="border-radius: 0.25rem">
                        @foreach($storeList as $key => $list)
                                <option value="{{$key}}" {{ (backpack_user()->hasAnyRole('', 'organizationadmin')) ? '' : ((backpack_user()->store_id == $key) ? 'selected' : '') }}>{{$list}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4 col-sm-6">
                    <div class="input-group mb-3">
                        ...
                        <select class="form-select store_id" id="to_store_id"  name="to_store_id" style="border-radius: 0.25rem"></select>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4 col-sm-6">
                    <div class="input-group mb-3">
                ...
                <div class="col-xl-4 col-lg-4 col-sm-6">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="adjustment_no">Stock Transfer Number</label>
                ...
                <div class="col-xl-4 col-lg-4 col-sm-6">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="transfer_adjustment_no">Stock Transfer Number</label>
                        <select class="form-select" id="transfer_adjustment_no" name="transfer_adjustment_no" {{ (count($stockTransferNumbers)<1) ? 'disabled' : '' }}>
                            @foreach ($stockTransferNumbers as $code => $codeId)
                                <option value="{{ $codeId }}">{{ $code }}</option>
                            @endforeach
                        </select>
                        <span class="input-group-text bg-primary text-white" id="sequenceCreateBtn" onclick="loadModal(this, '9')">
                            +
                        </span>
                    </div>
                </div>
                ...
                <tbody id="sales-table">
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                @if ($multiple_barcode)
                                    <button type="button" class="btn btn-primary btn-sm barcodeScan" id="barcodeScan-1" data-cntr="1"
                                ...
                                <input type="text" class="form-control p-1 salesAddQty" name="total_qty[1]" id="salesAddQty-1"
                                    ...
                                    style="border-top-left-radius: 0;border-bottom-left-radius: 0;" {{ $multiple_barcode ? 'readonly' : '' }}>
                            </div>
                        </td>
                        <td>
                            <div class="input-group">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <textarea  class="form-control" name="remarks" id="" cols="100" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
