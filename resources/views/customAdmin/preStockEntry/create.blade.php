...
<form id="chalanEntryForm" action="{{url($crud->route)}}" method="POST">
    @csrf
        ...
        <div class="row mt-3">
            ...
            <div class="col-xl-2 col-lg-4 col-sm-2">
                <div class="input-group mb-6">
                    ...
                    <input type="checkbox" checked="true" name="itemWiseDiscount" id="discountCheckbox" class="mt-2 mx-2">
                </div>
            </div>
            <div class="col-xl-2 col-lg-4 col-sm-6">
                <div class="input-group mb-3">
                    <input type="hidden"  value="1" class="form-control no_of_rows" id="no_of_rows" placeholder="Enter No. of Rows" readonly>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="input-group mb-3">
                    ...
                    <input type="number" min="0" max="100" id="flatDiscount" name="flat_discount" disabled="true" class="form-control" placeholder="Discount">
                </div>
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="input-group mb-3">
...
@include('customAdmin.preStockEntry.partials.scripts')
