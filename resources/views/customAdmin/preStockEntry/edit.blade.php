...
@section('content')
    ...
    <form id="chalanEntryForm" action="{{url($crud->route).'/'.$stock->id}}" method="PUT">
        @method('PUT')
        @csrf
...
{{--                Todo: Additional stock entry after approved --}}
                ...
                {{--                <div class="col-xl-2 col-lg-4 col-sm-6">--}}
{{--                    <div class="input-group mb-3">--}}
{{--                        <select class="form-select batch_no" id="batch_no"  name="batch_no">--}}
{{--                            <option value="" disabled selected>Select a previous batch</option>--}}
{{--                            @foreach($batchList as $key => $list)--}}
...
{{--                <div class="col-4">--}}
{{--                    <div class="input-group mb-3">--}}
{{--                        <span class="input-group-text">Stock Adjustment No</span>--}}
{{--                        <input type="text" class="form-control" name="adjustment_no" value="{{$stock->adjustment_no}}" placeholder="Adjustment No" >--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="col-4">--}}
{{--                    <div class="input-group mb-3">--}}
{{--                        <span class="input-group-text">Batch No</span>--}}
{{--                        <input type="text" name="batch_no" value="{{$stock->items->first()->batch_no}}"   class="form-control" placeholder="Batch No" >--}}
{{--                    </div>--}}
{{--                </div>--}}
        ...
        <div class="main-container mb-4">
            <div class="row ">
                <div class="col d-flex justify-content-end">
                    ...
                    @if($stock->sup_status_id !== \App\Models\SupStatus::APPROVED)
                        ...
                        @endif
                    @endif
                    <a href="{{url($crud->route)}}"><i  class="btn btn-danger me-1">{{$stock->sup_status_id == \App\Models\SupStatus::APPROVED ?'Back':'Cancel' }}</i></a>
                </div>
            </div>
        </div>
    </form>
...
@include('customAdmin.stockMgmt.partials.scripts')
