...
@section('content')
    <div class="billing_navbar">
        <div class="billing_nav">
            ...
            {{-- <form class="form-inline my-2 my-lg-0" id="searchCustomerForm" method="post">
                    <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" id="searchCustomerInput" name="searchCustomerInput"> --}}
            </form>
