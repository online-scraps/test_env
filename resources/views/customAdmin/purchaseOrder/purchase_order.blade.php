...
<body>
            ...
            <div class="row mt-3">
                ...
                <!-- <div class="col-4">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="purchase_order" name="purchase_order_num" placeholder="PO No" readonly>
                    </div>
                </div> -->
                <div class="col-md-4">
                    <div class="input-group mb-3">
                        ...
                        <select class="form-select" id="store" name="store_id">
                            <option value="{{isset($store->id)?$store->id:''}}" selected>{{isset($store->name_en)?$store->name_en:''}}</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <table class="table" style="min-width: 1200px;">
                ...
                <tbody id="po-table">
                    <tr class="item-row" id="item-row-1" tr-id="1">
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <select class="form-select po_discount_mode" id="po_discount_mode-1" tr-id="1" name="discount_mode_id[1]">
                                    <!-- <option value=''>--select--</option>     -->
    ...
    <script>
        ...
        $('#po_type').change(function() {
            ...
            let requested_store = '<?php echo $requested_store ?>';
            requested_store = JSON.parse(requested_store);
        ...
        $('#store').change(function() {
            ...
            // set requested_store_options
            for (let i = 0; i < requested_store.length; i++) {
                $("#requested_store").children().remove();
                // console.log(requested_store[i]);
                $("#requested_store").append($("<option>")
                    .val(requested_store[i]['id'])
                    .html(requested_store[i]['name_en']));
