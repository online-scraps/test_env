                ...
                <tbody id="stock-table">
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                @if ($multiple_barcode)
                                    <button type="button" class="btn btn-primary btn-sm barcodeScan" id="barcodeScan-1"
                                        data-cntr="1" data-toggle="modal">+</button>
                                @endif
                                <input type="number" min="0" class="form-control p-1 addQty" name="add_qty[1]"
                                    placeholder="Qty" id='addQty-1' data-cntr="1" size="1"
                        ...
                        <td>
                            <div class="input-group">
                                <input type="number" min="0" class="form-control p-1 freeQty"
                                    name="free_item[1]" placeholder="Free item" id="freeQty-1" data-cntr="1"
                    ...
                    <tr id="repeater" class="d-none">
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                @endif
                                <input type="number" min="0" class="form-control p-1 addQty" placeholder="Qty"
                                    size="1" {{ $multiple_barcode ? 'readonly' : '' }}
                                    style="border-top-left-radius: 0;border-bottom-left-radius: 0;">
                            </div>
                        </td>
                        <td>
                            <div class="input-group">
                                <input type="number" min="0" class="form-control p-1 freeQty"
                                    placeholder="Free item" size="1" {{ $multiple_barcode ? 'readonly' : '' }}>
                            </div>
                        </td>
                        <td>
                            <div class="input-group">
