    ...
    <div class="card shadow px-3 mt-4">
        ...
        <div class="mt-3">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="mb-3">
                        <span class="me-1" style="font-weight: bold;">Store Name: </span>
                        <span>{{ $entry->mstStore->name_en }}</span>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="mb-3">
                        <span class="me-1" style="font-weight: bold;">Batch No: </span>
                        <span>{{ $entry->getBatchNo() }}</span>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="mb-3">
                        <span class="me-1" style="font-weight: bold;">Date Ad: </span>
                        <span>{{ $entry->entry_date_ad ? dateToString($entry->entry_date_ad) : 'n/a' }}</span>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="mb-3">
                        <span class="me-1" style="font-weight: bold;">Date Bs:</span>
                        <span>{{ $entry->getDateString() }}</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td scope="col">{{ $item->depreciation ?? 'n/a' }}</td>
        ...
        <div>
            <div class="row">
                ...
                <div class="col-md-6 mt-2">
                    @if (isset($entry->upload_bill))
                        <a href="/storage/uploads/{{ $entry->upload_bill }}" target="_blank">
                            <img src="/storage/uploads/{{ $entry->upload_bill }}" alt="" width="100px">
                        </a>
                    @endif
                ...
                <div class="col-md-6">
                    <table class="table table-sm table-borderless text-dark">
                        ...
                        <tr>
                            <td class="font-weight-bold">Total Depreciation</td>
                            <td>{{ $entry->total_depreciation }}</td>
                        </tr>
                        <tr>
